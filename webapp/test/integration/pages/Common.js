sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("z/stock/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("z.stock.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["z/stock/localService/mockserver"], function (mockserver) {
