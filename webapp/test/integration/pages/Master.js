			...
			onTheMasterPage : {
							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("MaterailsSet", {
											Matnr : sCurrentId
										});
				...
				assertions : {
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all MaterailsSet to be able to check for the total amount
