sap.ui.define([
		...
		return BaseObject.extend("z.stock.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias z.stock.model.ListSelector
			 */
			 ...
			 * @return {z.stock.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
